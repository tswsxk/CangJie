...
class RFAG(object):
    ...
    def test(test_filename, test_epoch, dump_file=None, **kwargs):
        ...
        module = RFAG.load(test_epoch, **kwargs)
    ...
    def run(parse_args=None):
        ...
        eval("%s.%s" % (RFAG.__name__, subcommand))(**cfg_kwargs)
